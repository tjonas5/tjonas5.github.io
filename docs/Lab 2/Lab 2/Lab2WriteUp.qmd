...
vec = c("MATH", 240)
```
This vector has class character because it has both a character and a numeric in it, and the character is further to the right on the diagram from class, so it takes priority, and the whole vector becomes a character.